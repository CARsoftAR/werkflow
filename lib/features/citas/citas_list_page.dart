...
class _CitasListPageState extends State<CitasListPage> {
  ...
  Widget _buildCitaCard(BuildContext context, Cita cita) {
    ...
    final client = clients.cast<Cliente?>().firstWhere(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => NewCitaPage(cita: cita)),
            ),
            borderRadius: BorderRadius.circular(32),
            child: Padding(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${_getMonthName(cita.fechaHora.month)}'
                              .toUpperCase(),
                          style: TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.w900,
